...
public class UserDefinedJavaClassMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  @VisibleForTesting
  Class<?> cookClass( UserDefinedJavaClassDef def, ClassLoader clsloader ) throws CompileException, IOException, RuntimeException, KettleStepException, org.codehaus.janino.CompileException, ParseException, ScanException {
