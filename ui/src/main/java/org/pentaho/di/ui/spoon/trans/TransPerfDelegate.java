...
public class TransPerfDelegate extends SpoonDelegate {
  ...
  private void updateCanvas() {
	 ...
	 * chart.setTitle( title ); CategoryPlot plot = (CategoryPlot) chart.getPlot();
	 * plot.setBackgroundPaint( Color.white ); plot.setForegroundAlpha( 0.5f );
	 ...
	 * );
	 * 
	 * // dispose previous image... // if ( image != null ) { image.dispose(); }
	 * image = new Image( transGraph.getDisplay(), imageData );
	 * 
	 * // Draw the image on the canvas... // canvas.redraw();
	 */
  }
